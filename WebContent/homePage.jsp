   ...
   <div class = "middle">
      ...
      <div class = "middle-inner">
          <div class = "middle-details">
          	<h1>Sri Lankan Tourism Package Management</h1>
            <h4>Plan your new packages for customers</h4>
            <p>Sri Lanka tour and holiday packages make your dream travel come true with SL Tourism. Sri Lanka tour packages offer beautiful sultry beaches, bounteous hills and mountains, murmuring rivers,
               quiet lagoons and marshes, exciting wildlife, heritage sites, pilgrimage sites, 
               mouth-watering cuisine and more to pamper tourists from all over the world.</p>
               
               <div class = "btn">
                  <a href = "newPackage.jsp" class = "add">New Package</a>
                  <a href = "viewPackage.jsp" class = "view">Manage Package</a>
               </div>
          </div>
      </div>
       <br><br><br><br><br>
